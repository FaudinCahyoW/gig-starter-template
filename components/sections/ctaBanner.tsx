    ...
    <section className="py-20 px-6">
      <div className="max-w-5xl mx-auto rounded-3xl bg-linear-to-br from-primary/80 via-primary/40 to-card p-12 md:p-16 text-center">
         <div className="inline-flex justify-center mb-4">
          <Badge className=" bg-gray-800 text-[#38BDF8] flex">
            <Rocket />
            Langkah Awal Sukses Anda
          </Badge>
        </div>

        <h2 className="text-3xl text-purple-200 md:text-4xl font-bold mb-4">
          Wujudkan Landing Page Impian <br/> Bisnis Anda Hari Ini
        </h2>
        ...
        <Button size="lg" className="rounded-full mb-8 cursor-pointer">
          Jadwalkan Konsultasi Gratis
          <Calendar className="ml-2 h-4 w-4" />
        </Button>

        <div className="flex items-center justify-center gap-2 text-xs text-purple-100/80">
